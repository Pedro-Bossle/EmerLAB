...
import { situacoesParaRelatorioCadastros } from '../../../lib/prestadorCadastroHelpers.js'
...
export default function CadastroExportarPdfModal({
    ...
    const situacoesRelatorio = useMemo(
        () => situacoesParaRelatorioCadastros(situacoes),
        [situacoes],
    )

    const idsTodas = useMemo(
        () => situacoesRelatorio.map((s) => Number(s.id)).filter(Boolean),
        [situacoesRelatorio],
    )
