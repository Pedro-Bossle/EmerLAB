...
import SelectUfBusca from '../SelectUfBusca/SelectUfBusca.jsx'
...
export default function CidadeTabelaIbgeForm({
    ...
    const [buscaEnglobado, setBuscaEnglobado] = useState('')
    ...
    const opcoesEnglobados = useMemo(
        () =>
            outrosMunicipios.filter((m) => !englobadosSet.has(normalizarMunicipioChave(m.nome))),
        [outrosMunicipios, englobadosSet],
    )
                ...
                <label className="cidade_tabela_field_label">
                    ...
                    <div className="cidade_tabela_field_wrap cidade_tabela_field_wrap_select">
                        <SelectUfBusca
                            ...
                            emptyLabel="—"
                            onChange={(sigla) => onUfChange(sigla)}
                        />
                    </div>
                </label>
